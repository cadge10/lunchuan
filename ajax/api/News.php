...
Class News{
    ...
    /**
     * 新闻列表
     * @url http://api请求地址/api.php?mod=News&fun=getNewsList&page=xxx&size=xxx&time=xxxx&token=xxxx
     * @example news1.html How to use this function
     * @param int $page 页
     * @param int $size 每页数
     * @return array{code->状态码,msg->提示信息,data->数据数组}
     */
	public function getNewsList($page=0,$size=0){
     ...
     * @url http://api请求地址/api.php?mod=News&fun=getNewsInfo&id=xxx&time=xxxx&token=xxxx
     * @example news2.html How to use this function
     * @param Int $id 用户ID
     * @return array{code->状态码,msg->提示信息,data->数据数组}
     */
	public function getNewsInfo($id=0){
