...
if (base::p('action') == 'add') {
	...
	// 入库
	$sql = "insert into ###_product(userid,title,short_title,typeid,content,url,video_url,isshow,recommend,hot,pic,addtime,product_attribute_id) values 
	('$userid','$title','$short_title','$typeid','$content','$url','$video_url','$isshow','$recommend','$hot','$pic','$addtime','$product_attribute_id')";
	$db->query($sql);
	...
	exit(base::alert('产品添加成功，请返回。','?mod=admin_product'));
}
?>
<html>
<head>
...
<div id="tab_div_0">
  ...
  <tbody> 
    <tr>
	  <th width="107" align="left">产品名称：</th>
      <td width="552"><input type="text" id="title" name="title" size="50" /></td>
    </tr>
    <tr>
      <th align="left">产品短名称：</th>
      <td><input type="text" id="short_title" name="short_title" size="50" /> 
        *产品列表时显示的名称。</td>
    </tr>
    <tr>
      <th align="left">产品栏目：</th>
      <td><?php echo product::getartcol_p((int)base::g('typeid'),'请选择栏目……');?><span id="typemsg"></span></td>
      </tr>
    ...
    <tr>
      ...
      <td><input name="video_url" type="text" id="video_url" value="" size="50"> 
        *如果有视频，请填写视频的URL。</td>
    </tr>
    <tr>
...
<table cellspacing=0 cellpadding=0 width="100%" border=0 class="listtable">
  <tbody> 
    <tr>
      ...
      <td><select name="attributeid" id="attributeid" onChange="getAttrList(this.value,0)">
        ...
        * 请选择产品的所属类型，进而完善此产品的属性。
        <div class="noborder" id="getAttributeInfoAjax"></div>
        </td>
    </tr>
  </tbody> 
</table>
