...
if (base::p('action')=='add') {
	...
	$sql = "insert into ###_newstype(title,typeid,sortid,url,isshow)values('$title','$typeid','$sortid','$url','$isshow')";
	$db->query($sql);
	
	exit(base::alert('添加成功，请返回！','?mod=admin_news_type'));
}
?>
<html>
<head>
...
<table cellspacing=0 cellpadding=0 width="100%" border=0 class="listtable">
  <tbody> 
    ...
    <tr>
      ...
      <td><?php echo adminpub::getartcol((int)base::g('parentid'),'默认一级栏目');?></td>
    </tr>
    <tr>
