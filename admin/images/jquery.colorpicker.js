...
jQuery.extend({
	// btnid 点击打开颜色看的id，选择颜色块后，并赋予背景色
	// txtid 选择色块后，被赋予颜色值的表单项（如文本框或隐藏域）
    showcolor:function(btnid,txtid){showColorPanel(btnid,txtid);  }
})
// 使用方法
/*
<div id="title_colorimg" class="colorimg" style="background-color:"><!--可以放一个背景图片--></div>
<input type="hidden" id="title_style_color" name="style_color" value="" />
<script>$.showcolor("title_colorimg","title_style_color");</script>
*/
