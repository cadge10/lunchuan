...
class mysqli_db {
	...
	public function connect($charset = '') {
		...
		$conn = @mysqli_connect(DB_HOST.$db_part,DB_USER,DB_PASSWORD,DB_NAME);
		if (mysqli_connect_errno()) {
			printf("Connect failed: %s\n", mysqli_connect_error());
			exit();
		}
		$this->version = mysqli_get_server_info($conn);
		$this->link = $conn;
	...
	public function select_db($database) {
		$db = @mysqli_select_db($this->link, $database) or exit("Can't select MySQL database($database)!");
		return $db;
	}
